...
(function dartProgram() {
  ...
  F = {
    main() {
      ...
      vaihtoehdot.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "tyydytt\xe4v\xe4", "oikein", false], t1, t2));
      vaihtoehdot.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "hyv\xe4", "oikein", false], t1, t2));
      vaihtoehdot.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "kiitett\xe4v\xe4", "oikein", false], t1, t2));
      vaihtoehdot.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "erinomainen", "oikein", false], t1, t2));
      vaihtoehdot.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "v\xe4ltt\xe4v\xe4", "oikein", false], t1, t2));
      if (1 >= vaihtoehdot.length)
        return H.ioore(vaihtoehdot, 1);
      J.$indexSet$ax(vaihtoehdot[1], "oikein", true);
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Mik\xe4 arvosana 3 tarkoittaa?", "vaihtoehdot", vaihtoehdot], t1, t2));
      t2 = J.get$onClick$x(document.querySelector("#seuraava"));
      t1 = t2.$ti;
      t3 = t1._eval$1("~(1)?")._as(new F.main_closure(kysymykset, vaihtoehdot));
  ...
  F.main_closure.prototype = {
    call$1(e) {
      ...
      C.JSArray_methods.shuffle$0(this.vaihtoehdot);
      t2 = document;
      J.set$text$x(t2.querySelector("#seuraava"), "Toistaa kysymys");
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0];
      t3 = J.getInterceptor$asx(t1);
      t4 = t3.$index(t1, "teksti");
      J.set$text$x(t2.querySelector("#kysymys"), H._asStringS(t4));
      F.asetaVastausvaihtoehdot(t3.$index(t1, "vaihtoehdot"));
    },
    $signature: 4
  };
